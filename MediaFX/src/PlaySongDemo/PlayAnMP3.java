...
public class PlayAnMP3 extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    // I, Ryan Cabrera, changed the song to DanseMacabreViolinHook.mp3
    ...
    // I also changed the window size to a square.
    Scene scene = new Scene(pane, 255, 255); // 255 pixels wide, 85 pixels tall
